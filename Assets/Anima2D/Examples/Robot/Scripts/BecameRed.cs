...
public class BecameRed : StateMachineBehaviour
{
    ...
    override public void OnStateUpdate(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        foreach(SpriteRenderer spt in robot_Sprites){
            spt.material.color = Color.Lerp(spt.material.color,Color.red, time);
        }
        if(robot_Sprites[robot_Sprites.Count - 1].material.color == Color.red){
            animator.SetTrigger("Recoverring");
        }
    }
